...
| ★★☆ | [Rujaion](https://github.com/fukatani/rujaion) | GUI / Linux | Rujaion is an IDE simplified and spealized in competitive programming. Whole competitive programming tasks such as testing with sample cases, debugging and submission can be easily by GUI without installing any plugins or configuration. Currently, only Rust and C++ is supported. |
