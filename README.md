...
| ★★★ | [Grooking Algorithms](https://www.manning.com/books/grokking-algorithms), by Aditya Y. Bhargava | This book is fully illustrated, each explanations presented example includes helpful diagrams and fully annotated code samples, make it easy to learn how to use algoriths effectively in practical problems. Very recommended to beginner. |
