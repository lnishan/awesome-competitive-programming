...
| ★★☆ | Codeforces Parsers: ... [Codeforces Parser](https://github.com/johnathan79717/codeforces-parser) ... [GoCF](https://github.com/sukeesh/GoCF) ... [cfparser](https://github.com/gnull/cfparser) (emacs) [cfparser](https://github.com/ikatanic/cfparser) (cli) [codeforcify](https://github.com/kerolloz/codeforcify) (GUI)| These tools parse Codeforces contest problems and help run sample tests. |
